                                    ...
                                    <table class="table table-responsive-md">
                                        <thead>
                                            <tr>
												...
												<th><strong>Titre Module</strong></th>
										...
										descri_mod
										FROM
										tbl_module AS md INNER JOIN tbl_departement AS dp ON(md.id_depart=dp.id_depart)";
										$recupdata=$my_bd->prepare($sql);
										$recupdata->execute();
										$module=$recupdata->fetchALL(PDO::FETCH_ASSOC);
										?>
                                        <tbody>
											<?php
											...
											?>
                                            <tr>
                                                <td><?=$mod['nom_depart']?></td>
                                                <td><?=$mod['titre_mod']?></td>
												<td><?=$mod['prix_mod']?> Fbu</td>
                                                <td><?=$mod['duree_mod']?> Mois</td>
												<td>
                                                ...
                                                <td>
													<div class="d-flex">
														<button type="submit" class="buton_add" data-bs-toggle="modal" data-bs-target="#modi<?=$mod['id_mod']?>">&nbsp;&nbsp;<i class="fa fa-pencil icon_bo"></i>&nbsp;&nbsp;</button>&nbsp;&nbsp;
														<button type="submit" class="buton_close" data-bs-toggle="modal" data-bs-target="#supr<?=$mod['id_mod']?>">&nbsp;&nbsp;<i class="fa fa-trash icon_bo"></i>&nbsp;&nbsp;</button>
													</div>
												</td>
                                            </tr>
                                        </tbody>
										        				<!-- Modal Update-->
                                            <div class="modal fade" id="modi<?=$mod['id_mod']?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
															...
															<div class="modal-body">
																<div class="row">
																	<div class="col-12 col-lg-6  py-2">
																		<select name="input_depart" class="form-control">
																	...
																	<div class="col-12 col-lg-6  py-2">
																		<input type="hidden" name="id_module" value="<?=$mod['id_mod']?>">
																		<input type="text" class="form-control" name="input_module" value="<?=$mod['titre_mod']?>" placeholder="Titre Module">
																	</div>
																	<div class="col-12 col-lg-6  py-2">
																		<input type="text" class="form-control" name="input_prix" value="<?=$mod['prix_mod']?>" placeholder="Prix Module">
																	</div>
																	<div class="col-12 col-lg-6  py-2">
																		<input type="text" class="form-control" name="input_duree" value="<?=$mod['duree_mod']?>" placeholder="Duree Module">
																	</div>
																	<div class="col-12 col-lg-12 py-2">
																		<textarea name="input_descrmodule" class="form-control" cols="60" rows="5" value="<?=$mod['descri_mod']?>" placeholder="Description"><?=$mod['descri_mod']?></textarea>
																	</div>
												...
												<!-- Modal suprimer-->
											<div class="modal fade" id="supr<?=$mod['id_mod']?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
												<div class="modal-dialog">
													<div class="modal-content">
													<div class="modal-header">
													...
													<form method="POST">
														<div class="modal-body">
															<div class="row">
															<input type="hidden" name="id_module" value="<?=$mod['id_mod']?>">
															<p class="deleteclass">Veux-tu supprimer le module <span class="utinom"><?=$mod['titre_mod']?></span></p>
															</div>
														</div>
														<div class="modal-footer">
				...
				<form method="POST">
					<div class="modal-body">
						<div class="row">
							...
							<div class="col-12 col-lg-6  py-2">
								<input type="text" class="form-control" name="input_module" placeholder="Titre Module">
							</div>
							<div class="col-12 col-lg-6  py-2">
								<input type="text" class="form-control" name="input_prix" placeholder="Prix Module">
							</div>
							<div class="col-12 col-lg-6  py-2">
								<input type="text" class="form-control" name="input_duree" placeholder="Duree Module">
							</div>
							<div class="col-12 col-lg-12 py-2">
                                <textarea name="input_descrmodule" class="form-control" cols="60" rows="5" placeholder="Description"></textarea>
							</div>
