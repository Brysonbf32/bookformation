            ...
            <div class="header-content">
				...
				<div class="sub-header">
					<div class="d-flex align-items-center flex-wrap mr-auto">
						<h5 class="dashboard_bar">Gestion De Stagiaires</h5>
					</div>
        ...
        <div class="deznav">
            <div class="deznav-scroll">
				...
				<ul class="metismenu" id="menu">
					...
					<li><a href="module_detail.php" class="ai-icon" aria-expanded="false">
							<i class="flaticon-381-settings-2"></i>
							<span class="nav-text">Detail Module</span>
						</a>
					</li>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-responsive-md">
                                        <thead>
                                            <tr>
                                                <th><strong>Nom Secretaire</strong></th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
													<div class="d-flex">
														<button type="submit" class="buton_close" data-bs-toggle="modal" data-bs-target="#supr<?=$mod['id_secret']?>">&nbsp;&nbsp;<i class="fa fa-trash icon_bo"></i>&nbsp;&nbsp;</button>
													</div>
												</td>
                                            </tr>
                                        </tbody>
											<!-- Modal suprimer-->
											<div class="modal fade" id="supr<?=$mod['id_secret']?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
												<div class="modal-dialog">
													...
													<form method="POST">
														<div class="modal-body">
															<div class="row">
                                                            <input type="hidden" class="form-control" name="input_secr" value="<?=$sec['id_secret']?>">
															<p class="deleteclass">Veux-tu supprimer le module le secretaire&nbsp;<span class="utinom"><?=$sec['nom_utili']?></span></p>
															</div>
														</div>
