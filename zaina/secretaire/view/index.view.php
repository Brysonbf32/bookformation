...
<body>
	...
	<div class="nav-header">
		...
		<?php
		$countsta=current($my_bd->query("SELECT COUNT(*) FROM tbl_stagiares")->fetch());
		$departemnt=current($my_bd->query("SELECT COUNT(*) FROM tbl_departement")->fetch());
		$module=current($my_bd->query("SELECT COUNT(*) FROM tbl_module")->fetch());
		?>
			...
			<div class="container-fluid">
				<div class="row">
					<div class="col-xl-4 col-sm-6 m-t35">
						<div class="card card-coin">
							<div class="card-body text-center">
								<h2 class="text-black mb-2 font-w600"><?=$countsta?></h2>
								<p class="mb-0 fs-14">
									Stagiaires
								</p>	
							</div>
					...
					<div class="col-xl-4 col-sm-6 m-t35">
						<div class="card card-coin">
							<div class="card-body text-center">
								<h2 class="text-black mb-2 font-w600"><?=$departemnt?></h2>
								<p class="mb-0 fs-13">
									Departemts
								</p>	
							</div>
					...
					<div class="col-xl-4 col-sm-6 m-t35">
						<div class="card card-coin">
							<div class="card-body text-center">
								<h2 class="text-black mb-2 font-w600"><?=$module?></h2>
								<p class="mb-0 fs-14">
									Modules
								</p>	
							</div>
