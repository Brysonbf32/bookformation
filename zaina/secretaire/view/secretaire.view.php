                                    ...
                                    <table class="table table-responsive-md">
                                        <thead>
                                            <tr>
                                                ...
                                                <th><strong>naionnalitee</strong></th>
										...
										$sql="SELECT 
											...
											email_util
										FROM
											tbl_secretaire AS sc INNER JOIN tbl_users AS us ON(sc.id_user=us.id_user)";
											$recupdata=$my_bd->prepare($sql);
											$recupdata->execute();
											$secretaire=$recupdata->fetchALL(PDO::FETCH_ASSOC);
										?>
                                        <tbody id="searchosx">
											<?php
											foreach($secretaire as $sec){
											?>
                                            <tr>
                                                <td><?=$sec['nom_secret']?></td>
												<td><?=$sec['address_secret']?></td>
												<td><?=$sec['tele_secr']?></td>
												<td><?=$sec['nation_sec']?></td>
												<td><?=$sec['email_util']?></td>
                                                <td>
													<div class="d-flex">
														<button type="submit" class="buton_add" data-bs-toggle="modal" data-bs-target="#modi<?=$sec['id_secret']?>">&nbsp;&nbsp;<i class="fa fa-pencil icon_bo"></i>&nbsp;&nbsp;</button>&nbsp;&nbsp;
														<button type="submit" class="buton_close" data-bs-toggle="modal" data-bs-target="#supr<?=$sec['id_secret']?>">&nbsp;&nbsp;<i class="fa fa-trash icon_bo"></i>&nbsp;&nbsp;</button>
													</div>
												</td>
                                            </tr>
                                        </tbody>
																				        				<!-- Modal Update-->
										<div class="modal fade" id="modi<?=$sec['id_secret']?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
													...
													<form method="POST">
														<div class="modal-body">
															...
															<div class="col-12 col-lg-6  py-2">
																	<input type="hidden" class="form-control" name="input_id" value="<?=$sec['id_secret']?>">
																	<input type="text" class="form-control" name="input_nom" placeholder="Nom Stagiaire" value="<?=$sec['nom_secret']?>">
																</div>
																<div class="col-12 col-lg-6  py-2">
																	<input type="text" class="form-control" name="input_address" placeholder="Address" value="<?=$sec['address_secret']?>">
																</div>
																<div class="col-12 col-lg-6  py-2">
																	<input type="text" class="form-control" name="input_phobe" placeholder="Telephone" value="<?=$sec['tele_secr']?>">
																</div>
																<div class="col-12 col-lg-6  py-2">
																	<input type="text" class="form-control" name="input_natio" placeholder="Nationalitee" value="<?=$sec['nation_sec']?>">
																</div>
															</div>
														</div>
											...
											<!-- Modal suprimer-->
											<div class="modal fade" id="supr<?=$sec['id_secret']?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
												<div class="modal-dialog">
													<div class="modal-content">
													<div class="modal-header">
													...
													<form method="POST">
														<div class="modal-body">
															<div class="row">
                                                            <input type="hidden" class="form-control" name="input_id" value="<?=$sec['id_secret']?>">
															<p class="deleteclass">Veux-tu supprimer le module le secretaire&nbsp;<span class="utinom"><?=$sec['nom_secret']?></span></p>
															</div>
														</div>
														<div class="modal-footer">
			...
			<div class="modal-content">
				...
				<form method="POST">
					<div class="modal-body">
						<div class="row">
						<div class="col-12 col-lg-6  py-2">
							<input type="text" value="<?=$statusec?>" name="" id="">
								<input type="text" class="form-control" name="input_nom" placeholder="Nom Stagiaire">
							</div>
							<div class="col-12 col-lg-6  py-2">
								<input type="text" class="form-control" name="input_address" placeholder="Address">
							</div>
							<div class="col-12 col-lg-6  py-2">
								<input type="text" class="form-control" name="input_phobe" placeholder="Telephone">
							</div>
							<div class="col-12 col-lg-6  py-2">
								<input type="text" class="form-control" name="input_mnation" placeholder="Nationnalitee">
							</div>
						</div>
					</div>
					<div class="modal-footer">
