                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-responsive-md">
										...
										<?php
										$recupdata=$my_bd->query("SELECT * FROM tbl_users ORDER BY id_user DESC");
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
													<div class="d-flex">
														<button type="submit" name="ajouter" class="buton_add">&nbsp;&nbsp;<i class="fa fa-pencil icon_bo"></i>&nbsp;&nbsp;</button>&nbsp;&nbsp;
														<button type="submit" name="ajouter" class="buton_close">&nbsp;&nbsp;<i class="fa fa-trash icon_bo"></i>&nbsp;&nbsp;</button>
													</div>
												</td>
                                            </tr>
                                        </tbody>
